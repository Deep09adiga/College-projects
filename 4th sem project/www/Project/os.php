...
<nav>
			...
			<div id="site_content">
				<div id="sidebar_container">
					<FORM NAME ="form1" METHOD ="POST" ACTION ="os.php">
						<div class="sidebar">
							<h3><font face="ar destine">Operating system</font></h3>
							<Input type = 'Checkbox' Name ='ch1' value ="windows" />      WINDOWS</br></br>
							<Input type = 'Checkbox' Name ='ch2' value ="dos" />      DOS</br></br>
							<Input type = 'Checkbox' Name ='ch3' value ="linux" />      LINUX</br></br>
							<Input type = 'Checkbox' Name ='ch4' value ="mac" />      MAC</br></br>
						</div>
						<div class="sidebar">
