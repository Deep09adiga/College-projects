...
<li><a href="brand4.php">Primary Camera</a></li>
...
if (isset($_POST['Submit1'])) {
  ...
  elseif($ch1=='checked' && $ch2=='checked' && $ch3=='checked' && $ch4=='unchecked' )
    $result = mysqli_query($con,"SELECT * FROM system where screensize < 15.7");

  elseif($ch1=='checked' && $ch2=='checked' && $ch4=='checked' )
    $result = mysqli_query($con,"SELECT * FROM system where screensize < 14.5 or screensize > 15.6");

  elseif($ch1=='checked' && $ch3=='checked' && $ch4=='checked' )
    $result = mysqli_query($con,"SELECT * FROM system where screensize < 13.0 or screensize > 14.5");

  elseif($ch2=='checked' && $ch3=='checked' && $ch4=='checked' )
    $result = mysqli_query($con,"SELECT * FROM system where screensize > 13.0");

  elseif($ch1=='checked' && $ch2=='checked')
    $result = mysqli_query($con,"SELECT * FROM system where screensize < 14.5");

  elseif($ch1=='checked' && $ch3=='checked')
    $result = mysqli_query($con,"SELECT * FROM system where screensize < 13.0 or screensize between 14.5 and 15.6");

  elseif($ch1=='checked' && $ch4=='checked')
    $result = mysqli_query($con,"SELECT * FROM system where screensize < 13.0 or screensize >15.6");

  elseif($ch2=='checked' && $ch3=='checked')
    $result = mysqli_query($con,"SELECT * FROM system where screensize between 13.0 and 14.5 or screensize < 15.6");

  elseif($ch2=='checked' && $ch4=='checked')
    $result = mysqli_query($con,"SELECT * FROM system where screensize > 15.6 or screensize between 13.0 and 14.5");
  ...
  elseif($ch2=='checked')
    $result = mysqli_query($con,"SELECT * FROM system where screensize between 13.0 and 14.5");        

  elseif($ch3=='checked')
    $result = mysqli_query($con,"SELECT * FROM system where screensize between 14.5 and 15.6");

  elseif($ch4=='checked')
        $result = mysqli_query($con,"SELECT * FROM system where screensize > 15.6");
	else
	    $result = mysqli_query($con,"SELECT * FROM system ");    
