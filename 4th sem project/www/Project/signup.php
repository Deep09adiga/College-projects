...
if (frm.CPassword.value != frm.password.value) {alert('Password and confirm password does not match');frm.CPassword.focus();return false;}
...
<td><b>Street:</b></td>
<td><input id="Street" name="Street" type="text" maxlength="120" style="width:300px; border:1px solid #999999" /></td>
</tr><tr>
<td><b>City:</b></td>
