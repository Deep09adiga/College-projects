							...
							while($row = mysqli_fetch_array($result)){
								echo 	'<p>
											...
											<form action="action.php" method="POST"> 
												...
												<input type="submit" name="action" value="ADD TO CART" style="width:120px; height:30px;"> 
												<br><br>
												<input type="submit" name="action1" value="View Details"style="width:120px; height:30px;">
												<br>
											</form>
											<form action="details.php" method="POST"> 
												<input type="hidden" value="'.$row['SERIAL_NO'].'" name="hide"><br>
												<input type="submit" name="action2" value="BUY now" style="width:120px; height:30px;">
											</form>
										</p>  
