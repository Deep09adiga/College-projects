...
<nav>
			...
			<div id="site_content">
				<div id="sidebar_container">
					<FORM NAME ="form1" METHOD ="POST" ACTION ="brand.php">
						<div class="sidebar">
					...
					<?PHP
						...
						if (isset($_POST['Submit1'])) {
							...
							if($ch1=='unchecked' && $ch2=='checked' && $ch3=='checked' && $ch4=='checked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='dell' OR brand='lenovo' OR brand='hp' OR brand='sony'");		
							elseif($ch1=='checked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='checked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='apple' OR  brand='hp' OR brand='lenovo' OR brand='sony'");
							elseif($ch1=='checked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='checked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='apple' OR brand='dell' OR brand='lenovo' OR brand='sony'");
							elseif($ch1=='checked' && $ch2=='checked' && $ch3=='checked' && $ch4=='unchecked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='apple' OR brand='dell' OR brand='hp' OR brand='sony'");
							elseif($ch1=='checked' && $ch2=='checked' && $ch3=='checked' && $ch4=='checked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='apple' OR brand='dell' OR brand='hp' OR brand='lenovo'");
							elseif($ch1=='unchecked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='checked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='hp' OR brand='lenovo' OR brand='sony'");
							elseif($ch1=='unchecked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='checked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='dell'  OR brand='lenovo' OR brand='sony'");
							elseif($ch1=='unchecked' && $ch2=='checked' && $ch3=='checked' && $ch4=='unchecked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='dell' OR brand='hp'  OR brand='sony'");
							elseif($ch1=='unchecked' && $ch2=='checked' && $ch3=='checked' && $ch4=='checked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='dell' OR brand='hp' OR brand='lenovo'");
							elseif($ch1=='checked' && $ch2=='unchecked' && $ch3=='unchecked' && $ch4=='checked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='apple' OR brand='lenovo' OR brand='sony'");
							elseif($ch1=='checked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='unchecked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='apple' OR brand='hp' OR brand='sony'");
							elseif($ch1=='checked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='checked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='apple' OR brand='hp' OR brand='lenovo'");
							elseif($ch1=='checked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='unchecked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='apple' OR brand='dell' OR  brand='sony'");
							elseif($ch1=='checked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='checked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='apple' OR brand='dell' OR brand='lenovo'");
							elseif($ch1=='checked' && $ch2=='checked' && $ch3=='checked' && $ch4=='unchecked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='apple' OR brand='dell' OR brand='hp'");
							elseif($ch1=='unchecked' && $ch2=='unchecked' && $ch3=='unchecked' && $ch4=='checked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='lenovo' OR brand='sony'");
							elseif($ch1=='unchecked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='unchecked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='hp' OR brand='sony'");
							elseif($ch1=='unchecked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='checked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='hp' OR brand='lenovo'");
							elseif($ch1=='unchecked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='unchecked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='dell' OR brand='sony'");
							elseif($ch1=='unchecked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='checked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='dell' OR brand='lenovo'");
							elseif($ch1=='unchecked' && $ch2=='checked' && $ch3=='checked' && $ch4=='unchecked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='dell' OR brand='hp'");
							elseif($ch1=='checked' && $ch2=='unchecked' && $ch3=='unchecked' && $ch4=='checked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='apple' OR brand='lenovo'");
							elseif($ch1=='checked' && $ch2=='unchecked' && $ch3=='unchecked' && $ch4=='unchecked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='apple' OR brand='sony'");
							elseif($ch1=='checked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='unchecked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='apple' OR brand='dell'");
							...
							elseif($ch1=='unchecked' && $ch2=='unchecked' && $ch3=='unchecked' && $ch4=='checked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='lenovo'");
							...
							elseif($ch1=='checked' && $ch2=='unchecked' && $ch3=='unchecked' && $ch4=='unchecked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where brand='apple'");
