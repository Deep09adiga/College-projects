...
// Check connection
	...
	while($row = mysqli_fetch_array($result)){
		echo 	'<p>
				...
				.' Brand:'.$row['BRAND'].'<br> Model: '.$row['MODEL'].'<br>   PRICE:  '.$row['PRICE'].' Rs<br>   QUANTITY:  '.$row['QUANTITY'].'
				<form action="clear.php" method="POST"> 
				<input type="hidden" value="'.$row['SERIAL_NO'].'" name="hide"><br>
				<input type="submit" name="action1" value="Clear quantity by 1" style="width:120px; height:40px;" ><br><br>
...
<form action="clear.php" method="POST"> 
	<input type="hidden" value="'.$row['SERIAL_NO'].'" name="hide"><br>
	<input type="submit" name="action3" value="Clear cart" style="width:100px; height:40px;" ><br><br>
	<br><br>
	<br><br>
	</form>
';	  	
