...
<nav>
			...
			<div id="site_content">
				<div id="sidebar_container">
					<FORM NAME ="form1" METHOD ="POST" ACTION ="processor.php">
						<div class="sidebar">
							<h3><font face="ar destine">Processor</font></h3>
							<Input type = 'Checkbox' Name ='ch1' value ="i3" />      Intel I3</br></br>
							<Input type = 'Checkbox' Name ='ch2' value ="i5" />      Intel I5</br></br>
							<Input type = 'Checkbox' Name ='ch3' value ="i7" />      Intel I7</br></br>
						</div>
						<div class="sidebar">
      			...
      			<div class="content">
					<?PHP
						...
						if (isset($_POST['Submit1'])) {
							...
							if($ch1=='checked' && $ch2=='unchecked' && $ch3=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where processor='i3'");
								
							elseif($ch1=='unchecked' && $ch2=='checked' && $ch3=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where processor='i5'");
							
							elseif($ch1=='unchecked' && $ch2=='unchecked' && $ch3=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where processor='i7'");
							
							elseif($ch1=='checked' && $ch2=='checked' && $ch3=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where processor='i3' or processor='i5'");
							
							elseif($ch1=='checked' && $ch2=='unchecked' && $ch3=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where processor='i3' or processor='i7'");
							
							elseif($ch1=='unchecked' && $ch2=='checked' && $ch3=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where processor='i5' or processor='i7'");
							
							elseif($ch1=='checked' && $ch2=='checked' && $ch3=='checked')
