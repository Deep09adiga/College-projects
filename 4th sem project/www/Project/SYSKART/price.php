				...
				<div id="sidebar_container">
					<FORM NAME ="form1" METHOD ="POST" ACTION ="price.php">
						<div class="sidebar">
							...
							<Input type = 'Checkbox' Name ='ch1' value ="belo10" />     Below   20000</br></br>
							<Input type = 'Checkbox' Name ='ch2' value ="20-30" />     20000 - 30000</br></br>
							<Input type = 'Checkbox' Name ='ch3' value ="30-40" />      30000 - 40000</br></br>
							<Input type = 'Checkbox' Name ='ch4' value ="40-50" />      40000 - 50000</br></br>
							<Input type = 'Checkbox' Name ='ch5' value ="abv50" />      Above   50000</br></br>
						</div>
					...
					<?PHP
						...
						if (isset($_POST['Submit1'])) {
							...
							if($ch1=='unchecked' && $ch2=='checked' && $ch3=='checked' && $ch4=='checked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system price >20000");		
								
							elseif($ch1=='checked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='checked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where price<20000 or price > 30000");
							
							elseif($ch1=='checked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='checked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where price < 30000 or price > 40000");
							
							elseif($ch1=='checked' && $ch2=='checked' && $ch3=='checked' && $ch4=='unchecked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where price< 40000 or price>50000");
							
							elseif($ch1=='checked' && $ch2=='checked' && $ch3=='checked' && $ch4=='checked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where price<50000");
							
							elseif($ch1=='unchecked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='checked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where price>30000");
							
							elseif($ch1=='unchecked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='checked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where price between 20000 and 30000 or price>40000");
							
							elseif($ch1=='unchecked' && $ch2=='checked' && $ch3=='checked' && $ch4=='unchecked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where price between 20000 and 40000 or price>50000");
							
							elseif($ch1=='unchecked' && $ch2=='checked' && $ch3=='checked' && $ch4=='checked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where price between 20000 and 50000");
							
							elseif($ch1=='checked' && $ch2=='unchecked' && $ch3=='unchecked' && $ch4=='checked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where price<20000 or price>40000");
							
							elseif($ch1=='checked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='unchecked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where price<20000 or price between 30000 and 40000 or price>50000");
							
							elseif($ch1=='checked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='checked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where price<20000 or price between 30000 and 50000");
							
							elseif($ch1=='checked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='unchecked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where price <30000 or price > 50000");
							
							elseif($ch1=='checked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='checked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where price<30000 or price between 40000 and 50000");
							
							elseif($ch1=='checked' && $ch2=='checked' && $ch3=='checked' && $ch4=='unchecked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where price <40000");
							...
							elseif($ch1=='unchecked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='unchecked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where price between 30000 and 40000 or price>50000");
							
							elseif($ch1=='unchecked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='checked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where price between 30000 and 50000");
							
							elseif($ch1=='unchecked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='unchecked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where price between 20000 and 30000 or price>50000");
							
							elseif($ch1=='unchecked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='checked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where price between 20000 and 30000 or price between 40000 and 50000");
							
							elseif($ch1=='unchecked' && $ch2=='checked' && $ch3=='checked' && $ch4=='unchecked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where price>20000 and price<40000");
							
							elseif($ch1=='checked' && $ch2=='unchecked' && $ch3=='unchecked' && $ch4=='checked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where price<20000 or price between 40000 and 50000");
							
							elseif($ch1=='checked' && $ch2=='unchecked' && $ch3=='unchecked' && $ch4=='unchecked' && $ch5=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where price<20000 or price>50000");
							...
							elseif($ch1=='unchecked' && $ch2=='unchecked' && $ch3=='unchecked' && $ch4=='checked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where price between 40000 and 50000");
							
							elseif($ch1=='unchecked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='unchecked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where price between 30000 and 40000");
							
							elseif($ch1=='unchecked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='unchecked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where price between 20000 and 30000");
							
							elseif($ch1=='checked' && $ch2=='unchecked' && $ch3=='unchecked' && $ch4=='unchecked' && $ch5=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where price<20000");
