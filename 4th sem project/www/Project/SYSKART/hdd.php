...
<nav>
			...
			<div id="site_content">
				<div id="sidebar_container">
					<FORM NAME ="form1" METHOD ="POST" ACTION ="hdd.php">
						<div class="sidebar">
							<h3><font face="ar destine">Hard Disk</font></h3>
							<Input type = 'Checkbox' Name ='ch1' value ="320gb" />      320 GB</br></br>
							<Input type = 'Checkbox' Name ='ch2' value ="500gb" />      500 GB</br></br>
							<Input type = 'Checkbox' Name ='ch3' value ="720gb" />      720 GB</br></br>
							<Input type = 'Checkbox' Name ='ch4' value ="1tb" />      1 TB</br></br>
						</div>
					...
					<?PHP
						...
						if (isset($_POST['Submit1'])) {
							...
							if($ch1=='checked' && $ch2=='unchecked' && $ch3=='unchecked' && $ch4=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where hdd='320gb'");
							
							if($ch1=='unchecked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where hdd='500gb'");
							
							if($ch1=='unchecked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where hdd='720gb'");
							
							if($ch1=='unchecked' && $ch2=='unchecked' && $ch3=='unchecked' && $ch4=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where hdd='1tb'");
							
							if($ch1=='checked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where hdd='320gb' or hdd='500gb'");
							
							if($ch1=='checked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where hdd='320gb' or hdd='720gb'");
							
							if($ch1=='checked' && $ch2=='unchecked' && $ch3=='unchecked' && $ch4=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where hdd='320gb' or hdd='1tb'");
							
							if($ch1=='unchecked' && $ch2=='checked' && $ch3=='checked' && $ch4=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where hdd='500gb' or hdd='720gb'");
							
							if($ch1=='unchecked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where hdd='500gb' or hdd='1tb'");
							
							if($ch1=='unchecked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where hdd='720gb' or hdd='1tb'");
							
							if($ch1=='checked' && $ch2=='checked' && $ch3=='checked' && $ch4=='unchecked')
								$result = mysqli_query($con,"SELECT * FROM system where hdd='320gb' or hdd='500gb' or hdd='720gb'");
							
							if($ch1=='checked' && $ch2=='checked' && $ch3=='unchecked' && $ch4=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where hdd='320gb' or hdd='500gb' or hdd='1tb'");
							
							if($ch1=='checked' && $ch2=='unchecked' && $ch3=='checked' && $ch4=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where hdd='320gb' or hdd='1tb' or hdd='720gb'");
							
							if($ch1=='unchecked' && $ch2=='checked' && $ch3=='checked' && $ch4=='checked')
								$result = mysqli_query($con,"SELECT * FROM system where hdd='500gb' or hdd='1tb' or hdd='720gb'");
