      			...
      			<div class="content">
					<?PHP
						...
						if (isset($_POST['action'])) {
							...
							mysqli_query($con,"delete FROM cart where item_id=$ch1 and cart_user_id=$uname");
							$result = mysqli_query($con,"SELECT * FROM system where serial_no in(select item_id from cart where cart_user_id=$uname)");		
